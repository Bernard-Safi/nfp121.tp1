...
public class AuditeurCNAMTest extends junit.framework.TestCase {
    ...
    public void test_long_login(){
        question3.AuditeurCNAM auditeur1 = new question3.AuditeurCNAM("Julien",
                "Julien", "12345");
        assertEquals("longueur login",8,auditeur1.login().length());
    }
    public void test_long_nom(){
        question3.AuditeurCNAM auditeur1 = new question3.AuditeurCNAM("Julien",
                "Julien", "12345");
        assertEquals("longueur nom",6,auditeur1.nom().length());        
    }
}
